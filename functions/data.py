...
def search_correlation_from_pairs(corr_pairs: pd.DataFrame):
    """
    Suchfunktion für Korrelation zwischen 2 beliebigen Kompetenzen

    Args:
        corr_pairs (pd.DataFrame): Muss zusammen mit Variable 'Corr_pairs' ['Variable 1', 'Variable 2', 'Korrelation'] sein.
    """
